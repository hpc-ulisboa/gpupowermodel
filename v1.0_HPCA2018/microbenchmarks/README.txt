...
1 - README
    ...
    Here is provided a suite of CUDA microbenchmark applications, presented in [1],
    which can be used to characterize several of the main GPU components, namely the
    INT/SP/DP/SF Units, the L2-cache, the shared memory and the DRAM).
...
3 - USAGE
    ...
    of 6.1. If using the microbenchmarks on a different device, adjust the variable
